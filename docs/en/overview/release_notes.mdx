...
{/* release-notes-for-bugs?template=unfixedIssues&project=DEVOPS&version=(fixVersion ~ "katanomi-operator-v3.20.*" OR fixVersion ~ "knative-operator-v3.20.*" OR fixVersion ~ "jenkins-operator-v3.20.*") */}
