...
:::warning[Important: Ensuring Both Legacy and New Pipelines Work]
...
Please refer to the <ExternalSiteLink name="alauda-devops-pipelines" href="/configure/pod_template_guide" children="Pod Template Configuration Guide" />.
:::
