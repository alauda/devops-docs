...
This guide details the upgrade strategy and procedures for `Alauda DevOps` to `Alauda DevOps (Next-Gen)` when migrating from `Alauda Container Platform`  `v4.0` or `v4.1` to `v4.2`.
