...
After an overall rebuild of the DevOps platform, the DevOps Legacy module and its components will be deprecated in future versions. The list of components include:

- Alauda DevOps v3 (previously known as `Katanomi Operator`)
- Alauda DevOps Eventing v3 (previously known as `Knative Operator`)
- Alauda DevOps Gitlab v3 (previously known as `Gitlab Operator`)
- Alauda DevOps Harbor v3 (previously known as `Harbor Operator`)
- Alauda DevOps SonarQube v3 (previously known as `SonarQube Operator`)
- Alauda DevOps Nexus v3 (previously known as `Nexus Operator`)
- Alauda DevOps Jenkins v3 (previously known as `Jenkins Operator`)
- Alauda DevOps Tekton v3 (previously known as `Tekton Operator`)

The list of affected features are:
