...
{/* release-notes-for-bugs?template=fixed&version=jenkins-operator-v3.20.15 */}

#### Known Issues

{/* release-notes-for-bugs?template=unfixed&version=jenkins-operator-v3.20.15 */}
...
{/* release-notes-for-bugs?template=fixed&version=jenkins-operator-v3.20.8 */}

#### Known Issues

{/* release-notes-for-bugs?template=unfixed&version=jenkins-operator-v3.20.8 */}
